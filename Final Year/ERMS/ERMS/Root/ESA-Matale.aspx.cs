...
public partial class ESA_Matale : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        xmlDataBirth.Append("<chart caption='Year-Birth Report' subCaption='For Matale' Column3DSliceDepth='10' showBorder='1' formatNumberScale='0' numberSuffix=' '>");

        StringBuilder xmlDataDeath = new StringBuilder();
        xmlDataDeath.Append("<chart caption='Year-Death Report' subCaption='For Matale' Column3DSliceDepth='10' showBorder='1' formatNumberScale='0' numberSuffix=' '>");

        StringBuilder xmlDataPopulation = new StringBuilder();
        xmlDataPopulation.Append("<chart caption='Year-Population Report' subCaption='For Matale' Column3DSliceDepth='10' showBorder='1' formatNumberScale='0' numberSuffix=' '>");
        // ----------

        if (!IsPostBack)
        {
            objPopulation.strPredictDistrict = "Matale";
