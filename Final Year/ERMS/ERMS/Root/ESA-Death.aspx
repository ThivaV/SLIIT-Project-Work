<%@ Page Title="" Language="C#" MasterPageFile="~/NonGmapMasterPage.master" AutoEventWireup="true" CodeFile="ESA-Death.aspx.cs" Inherits="ESA_Death" %>
...
<table align="center" class="style1">
        <tr>
            <td class="style6" colspan="2">
                <asp:Image ID="Image1" runat="server" 
                    ImageUrl="~/ERMSimages/ESAimages/DeathPrediction.png" />
            </td>
        </tr>
        <tr>
            <td class="style6" colspan="2">
                <table align="center" class="style2" style="margin-left: 120px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnBack" runat="server" BackColor="#0066FF" 
                                BorderColor="#66FF33" BorderStyle="Solid" Font-Bold="True" ForeColor="White" 
                                Height="28px" onclick="btnBack_Click" Text="&lt;&lt; Back" Width="10em" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td class="style4" colspan="2">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <asp:Literal ID="DeathGraph" runat="server"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td class="style8">
                <table align="left" class="style3" style="margin-left: 20px">
                    <tr>
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="lblDeath" runat="server" Font-Bold="True" Font-Size="Medium" 
                                ForeColor="#585858" Text="Death Predictor" Visible="False"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:ListBox ID="LstDeath" runat="server" Height="160px" Visible="False" 
            ...
            <td class="style4">
                <asp:Literal ID="DeathPieGraph" runat="server"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td class="style4" colspan="2">
