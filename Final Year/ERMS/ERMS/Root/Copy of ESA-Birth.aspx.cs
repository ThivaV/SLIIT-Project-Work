    ...
    protected void btnEnter_Click(object sender, EventArgs e)
    {
        ...
        if(txtYear.Text != "")
        {
            ...
            if (Reg != "--Select--" && 0 <= t && t < 5)
            {
                ...
                xmlData.Append("<chart caption='Year-Birth Output Report' subCaption='By Value' Column3DSliceDepth='30' showBorder='1' formatNumberScale='0' numberSuffix=' '>");
                // ----------Pie------
                // -------------------
                ...
                for (int i = 0; i < Get; i++)
                {
                    ...
                    BirthGraph.Text = FusionCharts.RenderChart("FusionCharts/Line.swf", "", xmlData.ToString(), "Column3DRegVehRte", "900", "400", false, true);
                    /// 
                    /// ------------------------- 
                 }
                else
